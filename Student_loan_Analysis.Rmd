...
The following table presents a comparison between the total defaulted loans and the total recovery strategies from Q4 2015 to Q4 2018. There is a substantial gap between these two figures. Total defaults amount to trillions of dollars, whereas total recoveries are only in the millions. This makes the recoveries a mere drop in the bucket in terms of paying back the loans.
...
[Shiny_app](https://vokub9-jason-day.shinyapps.io/shinyloan)

<iframe src="https://vokub9-jason-day.shinyapps.io/shinyloan" style="width:100%; height:800px;"></iframe>
